...
<div class="flex min-h-full flex-col justify-center mt-20 px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" action="{{ route('selectUser') }}" method="POST">
            @csrf
            <div>
        ...
        <p class="mt-10 text-center text-sm text-gray-500">
            Not a member?
            <a href="{{ route('signUp') }}" class="font-semibold leading-6 text-blue-600 hover:text-blue-500">Register Now</a>
        </p>
    </div>
</div>
